...
# for testing
# says how many samples each family has
...
unique_samp_tables[["Soil"]] <- 
  unique_samp_tables[["Soil"]][
    !(unique_samp_tables[["Soil"]]$Family
                                        %in%
                                        c("Geosiphonaceae")),]
...
c = lapply(host_names_no_soil, grp, df = soho_samp_tables)
names(c) <- host_names_no_soil
...
d = lapply(host_names, grp, df = shared_samp_tables)
names(d) <- host_names
