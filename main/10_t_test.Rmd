...
#host_relabun_by_family <- lapply(host_names, stats_prep, unique_otu_tables)
...
write.csv(soho_pval_table, file="../outputs/soho_ttest_pvals_adjusted.csv")
...
merged_unique_relabun <- read.csv("../outputs/unique_relabun_table.csv", row.names = 1)

merged_shared_relabun <- read.csv("../outputs/shared_relabun_table.csv", row.names = 1)

merged_soil_host_relabun <- read.csv("../outputs/soho_relabun_table.csv", row.names = 1)
...
write.csv(final_unique_table, "../outputs/unique_relabun_pval_adjusted.csv")

write.csv(final_shared_table, "../outputs/shared_relabun_pval_adjusted.csv")

write.csv(final_soho_table, "../outputs/soil_host_relabun_pval_adjusted.csv")
