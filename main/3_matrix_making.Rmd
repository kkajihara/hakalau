...
readRDS("../intermediate_files/rds/ak_physeqs.rds")
readRDS("../intermediate_files/rds/ro_physeqs.rds")
readRDS("../intermediate_files/rds/ak_unrarefied.rds")
readRDS("../intermediate_files/rds/ro_unrarefied.rds")
...
# in the otu table, rows are samples (plots) and columns are ASVs
