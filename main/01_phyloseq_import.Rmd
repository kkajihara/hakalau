...
## test - remove only those ASVs with 0 reads - 1973 ASVs
# test_physeq <- prune_taxa(taxa_sums(unrarefied_physeq) > 0, unrarefied_physeq)

## Remove ASVs present with 1 or 0 reads - 1932 ASVs
unrarefied_physeq <- prune_taxa(taxa_sums(unrarefied_physeq) > 1, unrarefied_physeq)

## test - remove only those ASVs with 0 reads
test_physeq <- prune_taxa(taxa_sums(unrarefied_physeq) > 0, unrarefied_physeq)
