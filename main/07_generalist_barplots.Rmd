...
ggsave("../figures/core_shared_barplot.png", width = 11, height = 7)


# arguments are the same for noncore function

ro_shared_bar_noncore <- make_barplot(ro_shared_rbind,
                                 100,
                                 colors_ten_families,
                                 "\nRemnant Forest") 

ak_shared_bar_noncore <- make_barplot(ak_shared_rbind,
                                 100,
                                 colors_ten_families,
                                 "\nRestored Forest")
