...
nmds_plot <- ggplot(nmds_markdown, aes(x = NMDS1, y = NMDS2)) + 
    geom_point(data = nmds_markdown, size = 4, aes(shape = Habitat, colour = factor(Host, levels=host_names)), alpha = 0.8)+ 
    ...
    annotate("text", label="stress=0.261", x=0.8, y=-0.53, colour="black", size = 7) +
...
ggsave("../figures/nmds_with_geo.png", width=14, height=9)
