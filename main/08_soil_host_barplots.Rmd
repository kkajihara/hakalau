...
ro_soho_bar_notitle <- core_barplot_notitle(ro_soil_host_rbind,
                                              ro_soil_host_bar_sums,
                                              100,
                                              colors_ten_families)

ak_soho_bar_notitle <- core_barplot_notitle(ak_soil_host_rbind,
                                              ak_soil_host_bar_sums,
                                              100,
                                              colors_ten_families)
...
# first arrange side by side plots for shared and soho ASVs to get
# common legends for both (different families are present in each grouping)

both_soho <- ggarrange(ro_soho_bar_noncore,
                         ak_soho_bar_noncore, 
                         labels=c("A)", "B)"), 
                         hjust=-0.5, 
                         vjust = 5.5, 
...
both_soho_core <- ggarrange(ro_soho_bar_notitle,
                              ak_soho_bar_notitle,
                              labels=c("C)", "D)"),
                              hjust=-0.5,
                              vjust = 1,
...
all_soho_barplots <- ggarrange(both_soho,
                                 both_soho_core,
                                 ncol=1,
                                 nrow=2,
                                 heights = c(1.15, 1)) +
...
all_soho_barplots <- annotate_figure(all_soho_barplots,
...
ggsave("../figures/2x2_soho_barplots.png", width=11, height=12)
